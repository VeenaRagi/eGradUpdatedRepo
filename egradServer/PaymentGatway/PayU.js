...
//       SELECT user_id, studentregistationId
//       FROM log
//       WHERE email = ?
//     `;
//     const [userData] = await db.query(getUserIdQuery, [email]);
...
// console.log(updatePaymentStatusValues);
...
//     );
//     console.log("updatePaymentStatusValues",updatePaymentStatusValues);
...
//     if (!name || !email || !amount || !transactionId || !courseCreationId) {
...
//     const updatePaymentStatusValues = [userId, courseCreationId, studentRegistrationId];
...
//        AND studentregistationId = ? 
//        AND payu_status = "Paid"`,
//       updatePaymentStatusValues
//     );
