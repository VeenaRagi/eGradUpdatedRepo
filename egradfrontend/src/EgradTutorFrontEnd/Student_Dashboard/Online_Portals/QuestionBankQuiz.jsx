...
const QuestionBankQuiz = () => {
  ...
  window.addEventListener("load", function () {
    if (performance.navigation.type === 1) {
      ...
      //     console.error("Error deleting user data:", error);
      //   }
      // handleendthetest(userId);
      // setShowPopupallpb(true)
    }
  });
  ...
  //         const correctAnswerOptionId = currentQuestion.options[correctAnswerOptionIndex]?.option_id;
  //         console.log("Correct Answer Option ID:", correctAnswerOptionId);
  ...
  //   // Add your logic for moving to the next question here
  ...
  // State to hold the current answer value
  ...
  // function handleQType(currentQuestionType, qid) {
  //   setShowSolution(false);
  //   if (!showSolution) {
  //     // setShowSolution(true);
  //     setButtonText("View Solution");
  ...
  //       setSelectedQuestionId(updatedSelectedQuestionId);
  //     }
  //     console.log(currentQuestionType, " from handle qtype function........current question type")
  //     if (currentQuestionType.includes("MCQ4") || currentQuestionType.includes("MCQ5") || currentQuestionType.includes("CTQ") || currentQuestionType.includes("TF")) {
  //       console.log("returning to onsumit")
  //       onSubmit();
  //     }
  //     else if (currentQuestionType.includes("MSQN") || currentQuestionType.includes("MSQ")) {
  //       //  i have to add code of check boxes
  //       checkBoxes(qid);

  //     }
  //     else if (currentQuestionType.includes("NATD") || currentQuestionType.includes("NATI")) {
  //       console.log("retirning to on submit nat and natd ")
  //       // onSubmitnat()
  ...
  // useEffect(() => {
  //   // Reset the arrays when the question changes
  //   setFinalTry([]);
  //   setFinalTry2([]);
  //   setFinalTry3([]);
  ...
  //   const localStorageData = localStorage.getItem('your_storage_key');
  ...
  //     // Restore required data back to localStorage
  //     localStorage.setItem(
  //       'your_storage_key',
  //       JSON.stringify({
  //         studentDashbordconatiner,
        ...
        <div className="quiz_exam_interface_body">
          ...
          <div className="quiz_exam_interface_body_left_container">
                    ...
                    <div>
                      ...
                      <Tooltip title="Click here to Submit answer" arrow>
                        <button
                          ...
                          onClick={() => {
                            ; handleQType(currentQuestionType, questionData.questions[currentQuestionIndex].question_id)
                          }}
                        >
                          Submit
           ...
           visibility
                          ...
                          {/* For other question types (MCQ4, MCQ5, CTQ, MSQ, MSQN) */}
                          {/* {(currentQuestionType.includes("MCQ4") || currentQuestionType.includes("MCQ5")) && (
          ...
          visibility
                      ...
                      <Tooltip title="Click here to  End the Test" arrow>
                        ...
                        >
                          {/* Submit */}
                          End Test
                          {/* {showSolution ? 'Hide Solution' : 'Submit / Show Solution'} */}
                        </button>
                      </Tooltip>

                      {/* {submitted && selectedQuestionId.includes(currentQuestion.question_id) && (
                        <button onClick={toggleSolution} className="quizsave_next">
                          {showSolution ? 'Close Answer' : 'Show Answer'}
                        </button>
                      )} */}
                    </div>
