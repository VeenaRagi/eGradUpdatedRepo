...
import "./styles/StudentDashbordmyresult.css";
...
export const UserReport = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/Myresult/questionOptions_result/${testCreationTableId}/${userData.id}`
        );
  ...
  // console.log("solution", userData.id);
  // console.log(
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `${BASE_URL}/Myresult/YourPerformance_testResults/${userData.id}/${testCreationTableId}`
        );
  ...
  useEffect(() => {
    const fetchBuildChart = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/Myresult/AnswerEvaluation/${userData.id}/${testCreationTableId}`
        );
  ...
  useEffect(() => {
    axios
      .get(
        `${BASE_URL}/Myresult/userResponses/${userData.id}/${testCreationTableId}`
      )
      .then((response) => {
  ...
  //     try {
  //       const response = await fetch(
  //         // `${BASE_URL}/QuestionPaper/score/${testCreationTableId}/${userData.id}`
  //         `${BASE_URL}/Myresult/kevin/score/${userData.id}/${testCreationTableId}`
  //       );
  //       const data = await response.json();
  //       setScoreCount(data);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/Myresult/sectionwiseScoreAndTotalMarks/${userData.id}/${testCreationTableId}`
        );
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchiUserRankData = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/Myresult/rankforeachuser/${userData.id}/${testCreationTableId}`
        );
  ...
  useEffect(() => {
    const fetchUserMarks = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/Myresult/usermarks/${userData.id}/${testCreationTableId}`
        );
  ...
  const fetchInitialBookmarks = async () => {
    try {
      const response = await fetch(
        `${BASE_URL}/Bookmark/getBookmarks/${userData.id}`
      );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/Myresult/sectionwiseScore/${userData.id}/${testCreationTableId}`
        );
        const data = await response.json();
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [selectedSection, groupedQuestions, userData.id, testCreationTableId]);
