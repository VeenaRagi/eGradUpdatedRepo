...
const PGLeftNav = ({ decryptedUserIdState }) => {
    ...
    return (
        <>
            <div className="left_nav_bar_container">
                <div className="mobile_menu" onClick={() => setActiveSection(!activeSection)}>
                    <div className="quz_menu">
                        <div className="lines"></div>
                        <div className="lines"></div>
                        <div className="lines"></div>
                ...
                <div className="left-nav-bar">
                    <ul className="left-nav-bar-ul">
                        <li className={activeSection === "dashboard" ? "activeSD" : ""}>
                            <Link onClick={() => handleSectionClick("dashboard")} className="LeftnavLinks">
                                <p><i className="fa-solid fa-database logo_-clr"></i> Dashboard</p>
                            </Link>
                        </li>
                        <li className={activeSection === "examCreation" ? "activeSD" : ""}>
                            <Link onClick={() => handleSectionClick("examCreation")} className="LeftnavLinks">
                                <p><i className="fa-solid fa-user-pen logo_-clr"></i> Exam Creation</p>
                            </Link>
                        </li>
                        <li className={activeSection === "courseCreation" ? "activeSD" : ""}>
                            <Link onClick={() => handleSectionClick("courseCreation")} className="LeftnavLinks">
                                <p><i className="fa-solid fa-pen-nib logo_-clr"></i> Course Creation</p>
                            </Link>
                        </li>
                        <li className={activeSection === "instruction" ? "activeSD" : ""}>
                            <Link onClick={() => handleSectionClick("instruction")} className="LeftnavLinks">
                                <p><i className="fa-solid fa-person-chalkboard logo_-clr"></i> Instruction</p>
                            </Link>
                        </li>
                        <li className={activeSection === "testCreation" ? "activeSD" : ""}>
                            <Link onClick={() => handleSectionClick("testCreation")} className="LeftnavLinks">
                                <p><i className="fa-solid fa-file-lines logo_-clr"></i> Test Creation</p>
                            </Link>
                        </li>
                        <li className={activeSection === "documentUpload" ? "activeSD" : ""}>
                            <Link onClick={() => handleSectionClick("documentUpload")} className="LeftnavLinks">
                                <p><i className="fa-solid fa-folder-open logo_-clr"></i> Document Upload</p>
                            </Link>
                        </li>
                        <li className={activeSection === "videoUpload" ? "activeSD" : ""}>
                            <Link onClick={() => handleSectionClick("videoUpload")} className="LeftnavLinks">
                                <p><i className="fa-solid fa-video"></i> Upload Videos</p>
                            </Link>
                        </li>
                        <li className={activeSection === "registeredStudents" ? "activeSD" : ""}>
                            <Link onClick={() => handleSectionClick("registeredStudents")} className="LeftnavLinks">
                                <p><i><FaUserAlt /></i> Registered Students Info</p>
                            </Link>
                        </li>
                        <li className={activeSection === "studentDoubts" ? "activeSD" : ""}>
                            <Link onClick={() => handleSectionClick("studentDoubts")} className="LeftnavLinks">
                                <p><i className="fa-solid fa-question"></i> Student Doubt Section</p>
                            </Link>
                        </li>
                    </ul>
                </div>
            ...
            {activeSection === "dashboard" && <PGAdminDashBoardInLeftNav />}
            {activeSection === "examCreation" && <PgAdminExamCreation />}
            {activeSection === "courseCreation" && <PGAdminPortalCourseCreation />}
            {activeSection === "instruction" && <PGAdminInstructionPage />}
            {activeSection === "testCreation" && <PGAdminTestCreationForms />}
            {activeSection === "documentUpload" && <PGDocumentUploadAdmin />}
            {activeSection === "videoUpload" && <PGOvlVideosUpload />}
            {activeSection === "registeredStudents" && (
                <div className="admin_S_R_INfo">
                    <PGAccountInfo decryptedUserIdState={decryptedUserIdState} />
                </div>
            )}
            {activeSection === "studentDoubts" && <PGStudentDoubtSection />}
        </>
    );
};
