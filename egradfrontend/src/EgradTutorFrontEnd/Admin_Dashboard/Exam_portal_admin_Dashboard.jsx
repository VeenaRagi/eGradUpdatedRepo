...
const Exam_portal_admin_Dashboard = () => {
  ...
  const courseCount = useFetchCount(
    `${BASE_URL}/Dashboard/courses/count`
  );
  ...
  const questionCount = useFetchCount(
    `${BASE_URL}/Dashboard/question/count`
  );
  ...
  const handleViewCourse = () => {
    ...
    fetch(` ${BASE_URL}/Dashboard/course`)
      ...
      .then((data) => {
        ...
        setCourses(data);
        setCourseListOpen(!iscourseListOpen); 
        setShowCourses(true);
      })
      .catch((error) =>
                  ...
                  <div className="DASHBOARDCards_Section">
                    <div className="Dashboard_subcontainer">
                      <div className="Dashboard_contant">
                        ...
                        <h2>Total Exams </h2>
                        <button onClick={handleViewExams}>More info</button>
                        <div>
                          {showExams && (
                            <div
                      ...
                      <div className="Dashboard_contant">
                        ...
                        <button onClick={handleViewCourse}>More info</button>
                        <div>
                          {showCourses && (
                            <div
                              className="total_list"
