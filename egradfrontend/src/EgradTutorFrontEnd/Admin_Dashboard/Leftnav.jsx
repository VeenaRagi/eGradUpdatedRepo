...
import OvlvidesUpload from "../Admin_Dashboard/OVL_Admin/OvlvidesUpload.jsx";
...
const Leftnav = () => {
  ...
  const [showStudentDoubtSection, setshowStudentDoubtSection] =
    useState(false);
  ...
  return (
    <>
      <div className="left_nav_bar_container">
        ...
        >
          {/* <div className="quz_menu whiteMenu"> */}
          <div className={showMenu?"quz_menu":"whiteMenu"}>
