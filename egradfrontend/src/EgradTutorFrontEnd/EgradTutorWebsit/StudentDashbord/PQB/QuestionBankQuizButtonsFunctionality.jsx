...
const QuestionBankQuizButtonsFunctionality = ({
  onQuestionSelect,
  questionStatus,
  seconds,
  setQuestionStatus,
  ...
  const handleButtonClick = useCallback(
    async (questionNumber) => {
      ...
      // if(questionNumber=="View Solution" && questionNumber!=="View Solution"){
  ...
  QuestionBankQuizButtonsFunctionality.propTypes = {
...
export default QuestionBankQuizButtonsFunctionality;
