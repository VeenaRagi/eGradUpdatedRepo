...
console.log("11111111111111111111111111111111111111")
    ...
    const fetchAnswer = async () => {
      try {
        const responseAnswer = await fetch(
          `${BASE_URL}/UgTestResultPage/answer/${decryptedParam1}/${decryptedParam2}`
        );
  ...
  useEffect(() => {
    const fetchQuestionCount = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/UgTestResultPage/questionCount/${decryptedParam1}`
  ...
  useEffect(() => {
    const fetchQuestionCount = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/UgTestResultPage/attemptCount/${decryptedParam1}/${decryptedParam2}`
        );
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchCorrectAnswers = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/UgTestResultPage/correctAnswers/${decryptedParam1}/${decryptedParam2}`
        );
        const data = await response.json();
    ...
    const fetchCorrectAnswers = async () => {
      try {
        const response = await axios.get(
          `${BASE_URL}/UgTestResultPage/totalcurrectans/${decryptedParam1}/${decryptedParam2}`
        );
  ...
  useEffect(() => {
    const fetchQuestionCount = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/UgTestResultPage/incorrectAnswers/${decryptedParam1}/${decryptedParam2}`
        );
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchQuestionCount = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/UgTestResultPage/getStudentMarks/${decryptedParam1}/${decryptedParam2}`
  ...
  useEffect(() => {
    const fetchEmployeeData = async () => {
      try {
        const token = localStorage.getItem("token");
        const response = await fetch(
          `${BASE_URL}/UgTestResultPage/getEmployeeData`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
  ...
  useEffect(() => {
    const fetchQuestionCount = async () => {
      try {
        const response = await fetch(
          `${BASE_URL}/UgTestResultPage/getTimeLeftSubmissions/${decryptedParam1}/${decryptedParam2}`
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `${BASE_URL}/UgTestResultPage/user_answer`
        );
...
export default UgTestResultsPage;
